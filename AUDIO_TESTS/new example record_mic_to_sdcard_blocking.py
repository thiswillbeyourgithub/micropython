...
# create header for WAV file and write it
...
#pm.setPower(LD04, 1)  # this needs to be 1 for the audio playback so I tried for the recodring but no luck

audio_in = I2S(
    I2S_ID,
    sck=Pin(MIC_CLOCK),  # pin suggested from GPT4 after given https://github.com/lunokjod/watch/blob/b71340b486b68d7682a9021e454779557d7a291c/src/app/Mic.cpp#L60-L82
    ws=Pin(MIC_DATA),
    sd=Pin(MIC_DATA),
    mode=I2S.PDM_RX,  # should I use PDM_RX or RX?
...
print(num_sample_bytes_written_to_wav)
